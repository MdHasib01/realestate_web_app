...
const PropertyCardLandscape = ({ property }) => {
  ...
  return (
    <div className="bg-white flex rounded-lg border  relative">
      <div className=" overflow-hidden w-1/3 rounded-l relative">
        <img
          className="bg-gray-500 object-cover w-full rounded-t-lg hover:scale-105 ease-in-out duration-500"
...
export default PropertyCardLandscape;
